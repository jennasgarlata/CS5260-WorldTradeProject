...
class EUHeuristic:
    """Heuristic wrapper that scores a search node by Expected Utility (EU)."""

    def __init__(self, self_country, initial_world, templates):
    ...
    def apply(self, state):
        ...
        # Determine which countries participate in this schedule
